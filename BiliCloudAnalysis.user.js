...
// @downloadURL  https://i.ouo.chat/jsd/gh/mmyo456/BiliAnalysis@main/BiliCloudAnalysis.user.js
// @updateURL    https://i.ouo.chat/jsd/gh/mmyo456/BiliAnalysis@main/BiliCloudAnalysis.user.js
...
(function () {
    ...
    notificationBox.innerHTML = `
        <img src="https://jsd.onmicrosoft.cn/gh/mmyo456/BiliAnalysis-1@main/img/D26.gif" alt="图片" style="width: 50px; height: 50px;">
        <h3>解析成功</h3>
        <p>链接已复制到剪贴板</p>
    `;
