...
(function () {
    'use strict';
    var BiliAnalysisbutton = `<button id="BiliAnalysis6" style="z-index:999;width: 40px;color: rgb(255, 255, 255); background: rgb(0, 174, 236); border: 1px solid rgb(241, 242, 243); border-radius: 6px; font-size: 14px;top:850px;right:0px;position:fixed;">云端解析1</button>`;
    $("body").append(BiliAnalysisbutton)
    document.getElementById('BiliAnalysis6').addEventListener('click', clickBotton1)
    var BiliAnalysisbutton1 = `<button id="BiliAnalysis7" style="z-index:999;width: 40px;color: rgb(255, 255, 255); background: rgb(0, 174, 236); border: 1px solid rgb(241, 242, 243); border-radius: 6px; font-size: 14px;top:150px;left:0px;position:fixed;">云端解析1</button>`;
